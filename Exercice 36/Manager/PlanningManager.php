...
class PlanningManager {
    ...
    public function getSemaine() {
        ...
        $requete = $this->bdd->prepare('SELECT Activite.date, Activite.categorie, Adherent.prenom, Planning.statut FROM `Planning` INNER JOIN Adherent ON Planning.id_Adherent = Adherent.idAdherent INNER JOIN Activite ON Planning.id_Activite = Activite.idActivite WHERE WEEK(:semaine)');
